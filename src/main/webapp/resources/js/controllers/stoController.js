...
var StoController = function($scope, $http, $window, $timeout) {
	...
	$scope.saveData = function(taglpb) {
		var actionUrl = "sto/pushe?kdGudang="+$scope.selectedWhs.kode;
	...
	$scope.refreshDatalist = function() {
		var actionUrl = "sto/stolist.json";
		var res = $http.get(actionUrl, {
			params : {
				'kdGudang' : $scope.selectedWhs.kode
			}
	...
	$scope.updateData = function() {
		var actionUrl = "sto/upd?noReg="+$scope.tagLpb.noReg+"&kdGudang="+$scope.selectedWhs.kode;
		var resp = $http({
			method : 'POST',
			url : actionUrl,
